            ...
            <div class="orders-container" v-if="orderInfo">
                ...
                <div class="order-box" v-for="(item, index) in orderInfo" :key="index">
                    ...
                    <div class="order-body">
                        <div class="poster">
                            <img width="100" height="95" :src="imgPre + item.imgAddress">
                        </div>
                        ...
                        <div class="order-status" v-if="item.orderStatus == 0">待支付</div>
                        <div class="order-status" v-else-if="item.orderStatus == 1">已支付</div>
                        <div class="order-status" v-else>已关闭</div>
