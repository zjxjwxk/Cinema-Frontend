                ...
                <div class="cinema-brief-container">
                    ...
                    <div class="features-group">
                        ...
                        <div class="feature">
                            ...
                            <p class="desc text-ellipsis" title="免押金">（1）1.3米以下儿童（含1.3米）观看普通厅（2D、3D）（免费提供3D眼镜，无座），一位家长仅限携带一位儿童免费观影。（2）儿童观看巨幕厅、VIP厅影片均需购票</p>
                        </div>
                        <div class="feature">
                            <span class="tag ">可停车</span>
                            <p class="desc text-ellipsis" title="免押金">2017年6月1日起，杭州西溪印象城停车场将启动停车收费。每辆车每天有3小时的免费停车时间！超出3小时停车费也仅仅只收5元/小时！</p>
                        </div>
                    </div>
                </div>
            </div>
