<template>
    <div class="home-container">
        <div class="content" v-if="homeData.data">
            <div class="aside">
                <Today :boxRanking="homeData.data.boxRanking" v-if="homeData.data.boxRanking.length > 0"></Today>
              ...
              <!--</span>万-->
                    ...
                    <!--</div>-->
                <!--</div>-->
                <div class="most-expect-wrapper" v-if="homeData.data.expectRanking.length > 0">
                    <Expect :expectRanking="homeData.data.expectRanking"></Expect>
                </div>
                <div class="top100-wrapper" v-if="homeData.data.top100.length > 0">
                    <Top100 :top100="homeData.data.top100"></Top100>
                </div>
            </div>
            <div class="main">
                <div class="movie-grid">
                    <Hot :hotFilms="homeData.data.hotFilms" v-if="homeData.data.hotFilms.length > 0"></Hot>
                    <Recent :soonFilms="homeData.data.soonFilms" v-if="homeData.data.soonFilms.length > 0"></Recent>
                    <Hot-movie :boxRanking="homeData.data.boxRanking" v-if="homeData.data.boxRanking.length > 0"></Hot-movie>
                </div>
            </div>
        </div>
    </div>
