<template>
    <div class="panel">
      ...
      <span class="panel-more">
        ...
        <a href="/films?isPlay=1&amp;catId=1" data-act="tag-hotMovie-click" data-val="{TagName:'爱情'}">爱情</a>
      </span>
            <span class="panel-subtitle">
        <a href="/films?isPlay=1&amp;catId=2" data-act="tag-hotMovie-click" data-val="{TagName:'喜剧'}">喜剧</a>
      </span>
            <span class="panel-subtitle">
        <a href="/films?isPlay=1&amp;catId=8" data-act="tag-hotMovie-click" data-val="{TagName:'动作'}">动作</a>
      </span>
            <span class="panel-subtitle">
        <a href="/films?isPlay=1&amp;catId=5" data-act="tag-hotMovie-click" data-val="{TagName:'恐怖'}">恐怖</a>
      </span>
            <span class="panel-subtitle">
        <a href="/films?isPlay=1&amp;catId=3" data-act="tag-hotMovie-click" data-val="{TagName:'动画'}">动画</a>
      </span>
        </div>
                    ...
                    <div class="movie-item">
                        <nuxt-link :to="{path:'/filmItem/'+item.filmId}" target="_blank">
                            <div class="movie-poster movie-poster-long">
                                <img :src="imgPre+item.imgAddress">
                                <img :src="imgPre+item.imgAddress">
