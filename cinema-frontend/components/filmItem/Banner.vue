    ...
    <div class="banner">
        <div class="wrapper clearfix" v-if="filmItem && filmItem.data">
            ...
            <div class="celeInfo-right clearfix">
                ...
                <div class="action-buyBtn" v-if="filmItem.data.filmType != 2">
                ...
                <div class="movie-stats-container">
                    ...
                    <div class="movie-index">
                        ...
                        <div class="movie-index-content score normal-score">
                            <span class="index-left info-num ">
                                <span class="stonefont-big">{{filmItem.data.score}}</span>
                            </span>
                            <div class="index-right">
                                <div class="star-wrapper">
                                    <div class="star-on" :style="{width:filmItem.data.score * 10 + '%'}"></div>
                                </div>
                                <span class="score-num"><span>{{filmItem.data.scoreNum}} 万人评分</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="movie-index">
                        ...
                        <div class="movie-index-content box">
                            <span class="no-info">{{filmItem.data.totalBox}} 万</span>
                        </div>
                    </div>
                </div>
